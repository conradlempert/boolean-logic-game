var createLevel2_2 = function (){
    ...
    var a = level2_2.addInput('A', 2, 2, true);
    var b = level2_2.addInput('B', 2, 5, true);
    var c = level2_2.addInput('C', 2, 8, true);
    ...
    var a2 = level2_2.addInput('A', 18, 2, true);
    var b2 = level2_2.addInput('B', 18, 5, true);
    var c2 = level2_2.addInput('C', 18, 8, true);
